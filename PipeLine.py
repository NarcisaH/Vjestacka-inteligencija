...
plt.show()
# ----------------------------------------------------------
# 10) PIPELINE + CROSS VALIDATION + ROC CURVE
# ----------------------------------------------------------
...
# ---- Standard scaler + Model u pipeline-u ---- #
pipelines = {
...
for name, model in pipelines.items():
    ...
    print(f"\nModel: {name}")
    print(f"CV Score (mean): {cv_scores.mean():.3f}")
    print(f"CV Score (all folds): {cv_scores}")
